...
class OrderRepository extends BaseRepository {
  async insertPedido(conn, { idCliente, fechaPedido, observaciones, idSucursalOrigen = 1, metodoPago, cuotas, interes, descuento, totalConInteres }) {
    ...
    const [result] = await conn.query(sql, [idCliente, fechaPedido, observaciones || null, idSucursalOrigen || 1, metodoPago || 'Efectivo', cuotas || 1, interes || 0, descuento || 0, 0, totalConInteres || 0]);
